# QLab Media Player for Raspberry Pi (original single-display project)

> **Archived.** This is the original single-display QLab media player. The active
> project is the multi-display video wall in [`../videowall/`](../videowall/README.md);
> this folder is kept as the proven foundation it built on.
